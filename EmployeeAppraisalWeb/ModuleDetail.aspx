            ...
            <div class="" style="width: 100%;">
                <div class="col-md-12" style="border: 0px solid #008BFF; border-width: 0px 0px 1px 10px; border-bottom-color: #EDEDED; height: 150px;">
                    ...
                    <h6 style="margin-left: 5px;">User Story
                        <asp:Literal ID="ltrModuleID" runat="server"></asp:Literal></h6>
                    ...
                    <div class="col-md-3" style="margin-top: 15px; margin-left: -7px; border: 0px solid;">
                        ...
                        <asp:LinkButton ID="lnkbtnModuleAssign" runat="server" OnClick="lnkbtnModuleAssign_Click">
                            <asp:Image ID="imgTeamLeader" runat="server" Width="25px" Height="25px" Style="margin-top: -4px; margin-left: -2px; margin-right: -3px;" />
                            <asp:Label ID="lblTeamLeader" runat="server" Style="margin-left: 5px;"></asp:Label>
                        </asp:LinkButton>
                        ...
                        <div class="container-fluid">
                            <div class="col-md-12">
                                <div class="col-md-5" style="border: 0px solid;">
                                    ...
                                    <asp:TextBox ID="txtDDate" runat="server" type="date" Width="250px" Height="30px" Style="background-color: #eeeeee; border: 0px solid;" Visible="false"></asp:TextBox><br />
                                ...
                                <div class="col-md-5" style="border: 0px solid; margin-top: 0px;">
                                    <h3 style="padding: 0px; font-weight: 600; margin: 0px; padding-top: 5px;">
                                        <asp:Label ID="Label10" runat="server" Text="Project Name : " Width="180px"></asp:Label>
                        ...
                        <div class="container-fluid">
                            <div class="col-md-12">
                                <div class="col-md-5" style="border: 0px solid;">
                                    ...
                                    <label class="fileContainer text-center" style="font-size: 16px; font-family: 'Sanchez', serif; color: #0CBBC8; width: 100%; border: 2px solid #808080; padding: 30px; font-size: 25px; margin-top: 20px; border-radius: 5px; height: 100px; color: #808080;">
                                    ...
                                    <asp:Button ID="Button1" CssClass="btn btn-success pull-right" runat="server" Text="Upload" OnClick="Button1_Click" Visible="true" Style="margin-top: 20px; background-color: #008BFF; border-color: #008BFF; border-radius: 0px;" />
                                </div>
                                ...
                                <div class="col-md-7" style="border: 0px solid;">
                                    ...
                                    <%--<hr style="background-color: #808080; margin-top: 5px;" />--%>
                                    Task(<asp:Label ID="lblTask" runat="server" Style="font-size: 14px; color: #808080;"></asp:Label>)
                                    <div class="col-md-12" style="width: 100%; padding: 0px; margin-top: 10px; overflow-y: scroll; height: 240px;">
                                        <asp:Repeater ID="rptTaskList" runat="server" OnItemCommand="rptTaskList_ItemCommand">
                                            <ItemTemplate>
                                ...
                                <div class="col-md-12">
                                    <asp:LinkButton ID="LinkButton3" runat="server" Width="100%" Style="font-weight: bolder; color: #5a5a5a; border: 0px solid; border-bottom: 1px solid; padding-bottom: 2px; border-bottom-color: #808080; margin-top: 10px; margin-bottom: 20px;">Submitted Files</asp:LinkButton>
                                    <asp:Repeater ID="rptTaskFile" runat="server" OnItemCommand="rptTaskFile_ItemCommand">
                                        <ItemTemplate>
                                            <div class="col-md-3" style="margin-bottom: 10px;">
                                                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Download" CommandArgument='<%# Eval("TaskID") %>'>
                                                    <div class="col-md-12" style="background-color: #eeeeee;">
                                                        <h4>
                                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("Title") %>'></asp:Label></h4>
                                                        <asp:HiddenField ID="hdnSubmittedFile" runat="server" Value='<%# Eval("SubmittedFile") %>' />
                                                    </div>
                                                </asp:LinkButton>
                                            </div>
                                        </ItemTemplate>
                                ...
                                <%--<div class="col-md-12">
                                    <asp:LinkButton ID="LinkButton2" runat="server" Width="100%" Style="font-weight: bolder; color: #5a5a5a; border: 0px solid; border-bottom: 1px solid; padding-bottom: 2px; border-bottom-color: #808080; margin-top: 10px;">Related File Uploading</asp:LinkButton>
                                    <asp:FileUpload ID="fileUploadTask" runat="server" AllowMultiple="true" Visible="false" />
                                    <asp:Button ID="Button1" runat="server" Text="Button" OnClick="Button1_Click" Visible="false" />
                                    
                                    <div class="col-md-12 text-center" style="border: 2px solid #808080; padding: 50px; font-size: 25px; margin-top: 20px; border-radius: 5px; height: 150px; color: #808080;">Upload Files . . .</div>
                                </div>--%>
