                        ...
                        <div class="container-fluid">
                            <div class="col-md-12">
                                <div class="col-md-5" style="border: 0px solid;">
                                    ...
                                    <asp:TextBox ID="txtDiscussion" class="ckeditor" runat="server" TextMode="MultiLine" Style="background: #fff; border: 0px solid; width: 10px;"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <asp:LinkButton ID="LinkButton2" runat="server" Width="100%" Style="font-weight: bolder; color: #5a5a5a; border: 0px solid; border-bottom: 1px solid; padding-bottom: 2px; border-bottom-color: #808080; margin-top: 10px; margin-bottom: 20px;">Completed Work Uploading</asp:LinkButton>
                                    <asp:FileUpload ID="fileUploadTask" runat="server" AllowMultiple="true" />
