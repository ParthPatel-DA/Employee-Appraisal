<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="EmployeeProfile.aspx.cs" Inherits="EmployeeProfile" %>
                                            ...
                                            <li>
                                                <div class="agileits_work_grid view view-sixth">
                                                    ...
                                                    <div class="mask">
                                                        ...
                                                        <a href="AboutProject.aspx" style="margin-top: 40px;" class="info">Read More</a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ItemTemplate>
                        ...
                        <div class="agileits_tags" style="margin-top: 40px;">
                            ...
                            <asp:Panel ID="panelAddSkill" runat="server" Visible="false" Style="margin-bottom: 10px;">
                                ...
                                <div style="margin-top:10px; margin-bottom:10px;">
                                    <asp:Label ID="erroSkill" runat="server" Visible="false" style="color:#ff0000;"></asp:Label>
                                </div>
