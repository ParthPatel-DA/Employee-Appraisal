                        ...
                        <div class="login agile">
                            <div class="w3agile-border">
                                <div class="login-main login-agileits">
                                    ...
                                    <form method="post">
                                        <p>New Password</p>
                                        <asp:TextBox ID="txtNewPwd" runat="server" placeholder="New Password" TextMode="Password" required=""></asp:TextBox>
                            ...
                            <div class="w3agile-border">
                                <div class="login-main login-agileits">
                                    ...
                                    <form action="#" method="post">
                                        <p>First Name</p>
                                        <asp:TextBox ID="txtRegFname" runat="server" placeholder="First Name" required="" pattern="[a-zA-Z]+"></asp:TextBox>
                                        <p>Last Name</p>
                                        <asp:TextBox ID="txtRegLname" runat="server" placeholder="Last Name" required="" pattern="[a-zA-Z]+"></asp:TextBox>
                                        <p>Email</p>
                                        ...
                                        <p>Password</p>
                                        <asp:TextBox ID="txtRegPassword" runat="server" TextMode="Password" placeholder="Password" required=""></asp:TextBox>
                                        <p>Contact No</p>
                                        <asp:TextBox ID="txtRegCNO" runat="server" placeholder="Contact No" required="" MaxLength="15" pattern="[\+]\d{2}\d{10,15}" oninvalid="this.setCustomValidity('Please Enter Contact Number starting with country code (+91)')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
