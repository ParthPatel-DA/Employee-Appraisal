                                ...
                                <div class="col-md-3 container">
                                    <div class="group-control" style="padding-top: 20px; margin-left: 10px;">
                                        <div class="controls container">
                                            <asp:TextBox ID="txtFName" class="form-control" runat="server" type="text" Style="width: 200px; margin-top: 8px;" placeholder="Enter Your First Name" required="" pattern="[a-zA-Z]+" oninvalid="this.setCustomValidity('Enter Your First Name')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 container">
                                    <div class="group-control" style="padding-top: 20px; margin-left: 10px;">
                                        <div class="controls container">
                                            <asp:TextBox ID="txtLName" class="form-control" type="text" runat="server" Style="width: 200px; margin-top: 8px;" placeholder="Enter Your Last Name" required="" pattern="[a-zA-Z]+" oninvalid="this.setCustomValidity('Enter Your Last Name')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3 container">
                                    <div class="group-control" style="padding-top: 20px; margin-left: 10px;">
                                        <div class="controls container">
                                            <asp:TextBox ID="txtInqEmail" class="form-control" type="email" runat="server" Style="width: 200px; margin-top: 8px;" placeholder="Enter Your Email" required="" oninvalid="this.setCustomValidity('Enter Your Email')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 container">
                                    <div class="group-control" style="padding-top: 20px; margin-left: 10px;">
                                        <div class="controls container">
                                            <asp:TextBox ID="txtInqMNO" class="form-control" runat="server" Style="width: 200px; margin-top: 8px;" placeholder="Enter Your Mobile Number" required="" MaxLength="15" pattern="[\+]\d{2}\d{10,15}" oninvalid="this.setCustomValidity('Please Enter Contact Number starting with country code (+91)')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div>
                    <asp:Panel ID="PanelProDes" runat="server">
                        ...
                        <div>
                            ...
                            <div class="group-control" style="padding-top: 20px; margin-left: 90px;">
                                <div class="controls container">
                                    <asp:TextBox ID="txtTitle" class="form-control" runat="server" Style="width: 60%; margin-top: 8px;" placeholder="Title of your project" required="" pattern="[a-zA-Z_\.\ ]{5,15}" oninvalid="this.setCustomValidity('Please Enter Project Title')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="group-control" style="padding-top: 20px; margin-left: 90px;">
                                <div class="controls container">
                                    <asp:TextBox ID="txtProjectPlan" class="form-control" runat="server" type="number" Style="width: 60%; margin-top: 8px;" placeholder="Enter Days of Project Plan" required="" pattern="[1-9][0-9]{0,2}" min="0" oninvalid="this.setCustomValidity('Please Enter Days of Project Plan')" onchange="try{setCustomValidity('')}catch(e){}"></asp:TextBox>
                                </div>
                            </div>
