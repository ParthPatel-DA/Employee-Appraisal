<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="count">
        <div class="container">
            ...
            <div class="col-md-3 agile_count_grid">
                ...
                <div class="agile_count_grid_right">
                    <p class="counter"><asp:Label ID="lblServices" runat="server" Text=""></asp:Label></p>
                </div>
                <div class="clearfix"></div>
    ...
    <div class="work">
        ...
        <div class="agileits_work_grids">
            <ul id="flexiselDemo1">
                <asp:Repeater ID="rptViewProject" runat="server">
                    <ItemTemplate>
                        <li>
                            <div class="agileits_work_grid view view-sixth">
                                ...
                                <div class="mask">
                                    ...
                                    <a href="single.html" class="info" style="margin-top:40px;">Read More</a>
                                </div>
                            </div>
                        </li>
                    </ItemTemplate>
